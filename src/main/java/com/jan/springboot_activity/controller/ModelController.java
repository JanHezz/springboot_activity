...
public class ModelController {
   ...
   /* @GetMapping("/model/list")
    ...
    public void newModel(HttpServletResponse response,ModelAndView view) throws UnsupportedEncodingException {
  ...
  /*  @DeleteMapping("/model/{id}")
    ...
    public void saveModel(@PathVariable String modelId, String name, String key,String description, String json_xml, String svg_xml) {
        try {
            Model model = repositoryService.getModel(modelId);
